...
|---|---|
| VST2/3 x32 | ✅ Working - Bridging proved far too problematic. Added a standalone that has 32bit plugin support. There will NOT be a PHI32 VST3 version, unless I get enough request for it. |
