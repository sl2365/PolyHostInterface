...
{
public:
    static std::unique_ptr<juce::XmlElement> createXmlFromSessionData(const SessionData& session);
    static bool restoreSessionDataFromXml(const juce::XmlElement& xml,
                                          SessionData& session,
