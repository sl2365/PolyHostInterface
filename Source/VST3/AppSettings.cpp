...
int AppSettings::getPointerControlDragReturnDelayMs() const
{
    return juce::jlimit(0, 5000, xml->getIntAttribute(kPointerControlDragReturnDelayMs, 300));
}

void AppSettings::setPointerControlDragReturnDelayMs(int delayMs)
{
    xml->setAttribute(kPointerControlDragReturnDelayMs, juce::jlimit(0, 5000, delayMs));
    save();
}
