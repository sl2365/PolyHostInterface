...
public:
    ...
    void restoreEnabledDevicesFromSettings(const class AppSettings& settings);
    void saveEnabledDevicesToSettings(class AppSettings& settings) const;
    void refreshDevicesFromSettings(const class AppSettings& settings);
