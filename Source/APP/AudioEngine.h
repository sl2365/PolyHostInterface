...
public:
    ...
    void addDeviceManagerChangeListener(juce::ChangeListener* listener);
    void removeDeviceManagerChangeListener(juce::ChangeListener* listener);
    void showAudioSettingsDialog();
    void saveAudioDeviceStateToSettings(class AppSettings& settings) const;
    void restoreAudioDeviceStateFromSettings(const class AppSettings& settings);
