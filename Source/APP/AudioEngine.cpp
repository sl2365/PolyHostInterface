...
void AudioEngine::addDeviceManagerChangeListener(juce::ChangeListener* listener)
{
    deviceManager.addChangeListener(listener);
}

void AudioEngine::removeDeviceManagerChangeListener(juce::ChangeListener* listener)
{
    deviceManager.removeChangeListener(listener);
}

void AudioEngine::showAudioSettingsDialog()
{
...
void AudioEngine::saveAudioDeviceStateToSettings(AppSettings& settings) const
{
    settings.setAudioDeviceState(createAudioDeviceStateXml());
}

void AudioEngine::restoreAudioDeviceStateFromSettings(const AppSettings& settings)
{
    initialise(settings.getAudioDeviceState());
}
